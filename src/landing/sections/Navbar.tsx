...
export const Navbar: React.FC = () => {
  return (
    <header className="fixed w-full z-50 bg-white/90 backdrop-blur-md border-b border-[#343132]/5 transition-all duration-300">
      <div className="flex justify-between items-center max-w-7xl mx-auto px-6 py-4">
        ...
        <nav className="hidden md:flex gap-8 text-[#343132] font-medium text-sm tracking-wide">
          ...
          <a href="#why-timpla" className="hover:text-primary transition-colors">Why Timpla</a>
